...
\newcommand{\me}[2]{
    \author{
      ...
      {\bfseries 学号：}\underline{#2}\hspace{2em}
    }
  }
...
\newcommand{\realkw}{\text{\bf real}}
\newcommand{\idkw}{\text{\bf id}}
\newcommand{\ifkw}{\text{\bf if}}
\newcommand{\dokw}{\text{\bf do}}
\newcommand{\whilekw}{\text{\bf while}}
\newcommand{\printkw}{\text{\bf print}}
\newcommand{\thenkw}{\text{\bf then}}
\newcommand{\beginkw}{\text{\bf begin}}
\newcommand{\breakkw}{\text{\bf break}}
\newcommand{\funckw}{\text{\bf func}}
